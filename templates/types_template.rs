...
//! These types are auto-generated based on the actual API specification and responses.
//!
//! ## Usage
//!
//! ```rust
...
//! ## Context Caching
//!
//! DeepSeek provides automatic context caching. The `Usage` struct includes:
//! - `prompt_cache_hit_tokens`: Tokens from cache (0.1 yuan per million)
//! - `prompt_cache_miss_tokens`: Fresh tokens (1 yuan per million)
